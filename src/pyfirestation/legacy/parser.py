...
class LegacyArgumentParser(ArgumentParser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        file_group.add_argument("-wh", "--wind_height", metavar="PATH",
                                default="/home/qib/PyFireStationnn/FireInput/wind_height.asc",
                                help="Nuatmos Input/Output file.")
        file_group.add_argument("-ws", "--wind_speed", metavar="PATH",
